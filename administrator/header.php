...
<div class="animsition"> 
  <div class="row" id="topbar">
    ...
    <ul id="mynav" class="nav navbar-default nav-pills nav-justified collapse navbar-collapse" > <!--  navbar-fixed-top --> 
     ...
     <li role="presentation" <?php if($route=='contact') echo 'class="active"' ?> ><a  class="animsition-link" href="http://athul.noip.me:82/aluminiform">Alumini Form</a></li>
     <li role="presentation" <?php if($route=='job') echo 'class="active"' ?> ><a  class="animsition-link" href="http://athul.noip.me:82/jobform">Job Form</a></li>
    ...
    <?php }}else{?>
    <!-- Login header -->
    <li role="presentation" <?php if($route=='login') echo 'class="active"' ?> ><a  class="animsition-link" href="../placements.php">Login</a></li>
    <?php } ?>  
  </ul>
</div>
