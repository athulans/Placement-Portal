...
$Batch = $_POST["batch"];
$sgpa1 = is_null($_POST["sgpa1"])?0:$_POST["sgpa1"]*1;
$sgpa3 = is_null($_POST["sgpa3"])?0:$_POST["sgpa3"]*1;
$sgpa4 = is_null($_POST["sgpa4"])?0:$_POST["sgpa4"]*1;
$sgpa5 = is_null($_POST["sgpa5"])?0:$_POST["sgpa5"]*1;
$sgpa6 = is_null($_POST["sgpa6"])?0:$_POST["sgpa6"]*1;
$sgpa7 = is_null($_POST["sgpa7"])?0:$_POST["sgpa7"]*1;
$sgpa8 = is_null($_POST["sgpa8"])?0:$_POST["sgpa8"]*1;
$Supply = $_POST["supply"];
$Placed = $_POST["placed"];
